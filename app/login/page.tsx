            ...
            <div className="relative z-10">
                ...
                <header className="w-full px-8 py-6 flex items-center justify-between">
                    ...
                    <nav className="flex items-center gap-6">
                        <Link href="/signup" className="text-white opacity-50 hover:opacity-100 transition-opacity">
                            Signup
                        </Link>
                        <div className="h-5 w-px bg-white opacity-50" />
                        <Link href="/login" className="text-white hover:opacity-80 transition-opacity bg-yellow-600 px-3 py-1 rounded-full">
                            Login
                        </Link>
                    </nav>
                    ...
                    <nav className="flex items-center gap-8">
                        <Link href="/" className="text-white opacity-50 hover:opacity-100 transition-opacity">
                            Home
                        </Link>
                    </nav>
                </header>
                ...
                {/* Main Content */}
                <main className="flex items-center justify-center px-8 pt-24">
                    <div className="w-full max-w-[500px] mx-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="email" className="text-white opacity-50 text-left">
                                    Email Address
                                </label>
                                <input
                                    id="email"
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center justify-between">
                                    <label htmlFor="password" className="text-white opacity-50 text-left">
                                        Password
                                    </label>
                                    <button
                                        type="button"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full bg-[#18a2b8] text-white rounded-full h-[60px] hover:bg-[#15909f] transition-colors ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            >
